...
def test_verify_aadhaar_with_missing_aadhaar_number(client):
    """
    Test verifying Aadhaar number with missing 'aadhaar_number' field.
...
def test_verify_aadhaar_with_missing_captcha(client):
    """
    Test verifying Aadhaar number with missing 'captcha' field.
    Expected response: 400 Bad Request
    """
    payload = {
        "aadhaar_number": "123456789012"
...
# 🔄 REGENERATED - Endpoint modified
def test_verify_aadhaar_with_internal_server_error(client):
    """
    Test verifying Aadhaar number with an internal server error.
    Expected response: 500 Internal Server Error
    """
    # This test assumes that the server can be configured to return a 500 error for testing purposes
    payload = {
        "aadhaar_number": "123456789012",
        "captcha": "abc123"
    }
