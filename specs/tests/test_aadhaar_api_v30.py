...
# POST /api/v1/aadhaar/demographics


# ========================================
# PRESERVED TESTS (23 tests from previous version)
...
def test_demographics_success(client):
    """Test successful retrieval of demographics with valid aadhaar number and consent."""
...
def test_demographics_missing_aadhaar(client):
    """Test missing required field aadhaar_number."""
    response = client.post('/api/v1/aadhaar/demographics', json={
        "consent": True
    })
    assert response.status_code == 400
...
def test_demographics_invalid_aadhaar_format(client):
    """Test invalid format for aadhaar_number."""
    response = client.post('/api/v1/aadhaar/demographics', json={
