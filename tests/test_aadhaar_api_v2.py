...
📅 Generated:          2025-10-16 16:26:48
📂 Version:            v2
🔖 Spec Hash:          de32358866ca3705...
...
def test_demographics_unauthorized(session):
    """
    ...
    response = session.post(f"{BASE_URL}/aadhaar/demographics", json=payload, headers={"Authorization": "InvalidToken"})
