"""AI-Generated Tests v65 - 2025-10-29 20:50:47"""
import pytest
...
def test_health_check_service_unavailable(client, monkeypatch):
    ...
    """
    # Mocking the internal state to simulate a service unavailable scenario
    def mock_health_check():
        return False

    monkeypatch.setattr('api.dummy_aadhaar_api.is_service_available', mock_health_check)
