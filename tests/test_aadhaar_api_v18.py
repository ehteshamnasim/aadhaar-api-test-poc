"""AI-Generated Tests v18 - 2025-10-17 12:01:27"""
import pytest
...
def test_get_demographics_missing_field_aadhaar(client):
    response = client.post('/api/v1/aadhaar/demographics', json={'consent': True})
    assert response.status_code == 400


def test_get_demographics_missing_field_consent(client):
